...
import { MultiChainAnalysis } from './components/MultiChainAnalysis';
...
export const MainScreen: React.FC<MainScreenProps> = ({ onOpenOptions }) => {
  ...
  // Handle stream connection when wallet is connected and onchain notification is enabled (temporarily disabled)
  ...
  // Webhook functionality has been removed as requested
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ flex: 1 }}>
          ...
          {/* Webhook Controls removed as requested */}
